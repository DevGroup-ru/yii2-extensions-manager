...
namespace fakedev2\FakeFour\models;

use DevGroup\ExtensionsManager\models\BaseConfigurationModel;
use fakedev2\FakeFour\FakeFourModule;
use Yii;
...
class FakeConfiguration extends BaseConfigurationModel
{
    ...
    {
        return FakeFourModule::className();
    }
    ...
    {
        return [
            'testConfigName' => Yii::t('fake-four', 'test config name'),
            'testConfigNumber' => Yii::t('fake-four', 'test config number'),
            'testConfigDescription' => Yii::t('fake-four', 'test config description'),
        ];
    }
    ...
    public function commonApplicationAttributes()
    {
        return [
            ...
            'modules' => [
                'fake-four' => [
                    'class' => FakeFourModule::className(),
